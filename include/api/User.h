...
enum User_Category_Key{
	USER_CATEGORY_DEFAULT,
	USER_CATEGORY_ENT,
	USER_CATEGORY_HK_FAMOUS,
	USER_CATEGORY_MODEL,
	USER_CATEGORY_COOKING,
	USER_CATEGORY_SPORT,
	USER_CATEGORY_FINANCE,
	USER_CATEGORY_TECH,
	USER_CATEGORY_SINGER,
	USER_CATEGORY_WRITER,
	USER_CATEGORY_MODERATOR,
	USER_CATEGORY_MEDIUM,
	SER_CATEGORY_STOCKPLAYER
};
class User
{
public:
